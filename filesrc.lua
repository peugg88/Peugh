...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>peu gg chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "peu gg", HidePremium = false, IntroText = "peu gg⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("peu gg SCRIPT")
W:AddLabel("Discordpeu gg")
local Section = W:AddSection({
    Name = "Status"
})
